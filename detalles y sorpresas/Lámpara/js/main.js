document.addEventListener('DOMContentLoaded', function() {
            ...
            // Función para el efecto máquina de escribir y mostrar el gif al terminar
            function typeLoveMessage() {
                if (!loveMessage) return;
                loveMessage.textContent = '';
                loveMessage.style.opacity = '1';
                let i = 0;
                const gifContainer = document.getElementById('love-gif-container');
                ...
                function type() {
                    if (i <= originalMessage.length) {
                        ...
                        // Mostrar el gif cuando termina la frase
